...
namespace ncaa_grad_info
{
    class Program
    {
        ...
        public static Conference AggregateConfData(List<College> NCAACollegeData, string footballConfSelection)
        {
            ...
            NCAAConfData.AVG_FED_N_2011_SA = NCAACollegeData.Sum(item => item.FED_N_2011_SA);
            NCAAConfData.AVG_FED_N_2010_SA = NCAACollegeData.Sum(item => item.FED_N_2010_SA);
            NCAAConfData.AVG_FED_N_2009_SA = NCAACollegeData.Sum(item => item.FED_N_2009_SA);
            NCAAConfData.AVG_FED_N_2008_SA = NCAACollegeData.Sum(item => item.FED_N_2008_SA);
            NCAAConfData.AVG_FED_N_2007_SA = NCAACollegeData.Sum(item => item.FED_N_2007_SA);
            NCAAConfData.AVG_FED_N_2006_SA = NCAACollegeData.Sum(item => item.FED_N_2006_SA);
            NCAAConfData.AVG_FED_N_2005_SA = NCAACollegeData.Sum(item => item.FED_N_2005_SA);
            NCAAConfData.AVG_FED_N_2004_SA = NCAACollegeData.Sum(item => item.FED_N_2004_SA);
            NCAAConfData.AVG_FED_N_2003_SA = NCAACollegeData.Sum(item => item.FED_N_2003_SA);
            NCAAConfData.AVG_FED_N_2002_SA = NCAACollegeData.Sum(item => item.FED_N_2002_SA);
            NCAAConfData.AVG_FED_N_2001_SA = NCAACollegeData.Sum(item => item.FED_N_2001_SA);
            NCAAConfData.AVG_FED_N_2000_SA = NCAACollegeData.Sum(item => item.FED_N_2000_SA);
            NCAAConfData.AVG_FED_N_1999_SA = NCAACollegeData.Sum(item => item.FED_N_1999_SA);
            NCAAConfData.AVG_FED_N_1998_SA = NCAACollegeData.Sum(item => item.FED_N_1998_SA);
            NCAAConfData.AVG_FED_N_1997_SA = NCAACollegeData.Sum(item => item.FED_N_1997_SA);
            NCAAConfData.AVG_FED_N_1996_SA = NCAACollegeData.Sum(item => item.FED_N_1996_SA);
            NCAAConfData.AVG_FED_N_1995_SA = NCAACollegeData.Sum(item => item.FED_N_1995_SA);
            NCAAConfData.AVG_FED_RATE_2011_SA = NCAACollegeData.Sum(item => item.FED_RATE_2011_SA);
            NCAAConfData.AVG_FED_RATE_2010_SA = NCAACollegeData.Sum(item => item.FED_RATE_2010_SA);
            NCAAConfData.AVG_FED_RATE_2009_SA = NCAACollegeData.Sum(item => item.FED_RATE_2009_SA);
            NCAAConfData.AVG_FED_RATE_2008_SA = NCAACollegeData.Sum(item => item.FED_RATE_2008_SA);
            NCAAConfData.AVG_FED_RATE_2007_SA = NCAACollegeData.Sum(item => item.FED_RATE_2007_SA);
            NCAAConfData.AVG_FED_RATE_2006_SA = NCAACollegeData.Sum(item => item.FED_RATE_2006_SA);
            NCAAConfData.AVG_FED_RATE_2005_SA = NCAACollegeData.Sum(item => item.FED_RATE_2005_SA);
            NCAAConfData.AVG_FED_RATE_2004_SA = NCAACollegeData.Sum(item => item.FED_RATE_2004_SA);
            NCAAConfData.AVG_FED_RATE_2003_SA = NCAACollegeData.Sum(item => item.FED_RATE_2003_SA);
            NCAAConfData.AVG_FED_RATE_2002_SA = NCAACollegeData.Sum(item => item.FED_RATE_2002_SA);
            NCAAConfData.AVG_FED_RATE_2001_SA = NCAACollegeData.Sum(item => item.FED_RATE_2001_SA);
            NCAAConfData.AVG_FED_RATE_2000_SA = NCAACollegeData.Sum(item => item.FED_RATE_2000_SA);
            NCAAConfData.AVG_FED_RATE_1999_SA = NCAACollegeData.Sum(item => item.FED_RATE_1999_SA);
            NCAAConfData.AVG_FED_RATE_1998_SA = NCAACollegeData.Sum(item => item.FED_RATE_1998_SA);
            NCAAConfData.AVG_FED_RATE_1997_SA = NCAACollegeData.Sum(item => item.FED_RATE_1997_SA);
            NCAAConfData.AVG_FED_RATE_1996_SA = NCAACollegeData.Sum(item => item.FED_RATE_1996_SA);
            NCAAConfData.AVG_FED_RATE_1995_SA = NCAACollegeData.Sum(item => item.FED_RATE_1995_SA);
            NCAAConfData.AVG_GSR_N_2011_SA = NCAACollegeData.Sum(item => item.GSR_N_2011_SA);
            NCAAConfData.AVG_GSR_N_2010_SA = NCAACollegeData.Sum(item => item.GSR_N_2010_SA);
            NCAAConfData.AVG_GSR_N_2009_SA = NCAACollegeData.Sum(item => item.GSR_N_2009_SA);
            NCAAConfData.AVG_GSR_N_2008_SA = NCAACollegeData.Sum(item => item.GSR_N_2008_SA);
            NCAAConfData.AVG_GSR_N_2007_SA = NCAACollegeData.Sum(item => item.GSR_N_2007_SA);
            NCAAConfData.AVG_GSR_N_2006_SA = NCAACollegeData.Sum(item => item.GSR_N_2006_SA);
            NCAAConfData.AVG_GSR_N_2005_SA = NCAACollegeData.Sum(item => item.GSR_N_2005_SA);
            NCAAConfData.AVG_GSR_N_2004_SA = NCAACollegeData.Sum(item => item.GSR_N_2004_SA);
            NCAAConfData.AVG_GSR_N_2003_SA = NCAACollegeData.Sum(item => item.GSR_N_2003_SA);
            NCAAConfData.AVG_GSR_N_2002_SA = NCAACollegeData.Sum(item => item.GSR_N_2002_SA);
            NCAAConfData.AVG_GSR_N_2001_SA = NCAACollegeData.Sum(item => item.GSR_N_2001_SA);
            NCAAConfData.AVG_GSR_N_2000_SA = NCAACollegeData.Sum(item => item.GSR_N_2000_SA);
            NCAAConfData.AVG_GSR_N_1999_SA = NCAACollegeData.Sum(item => item.GSR_N_1999_SA);
            NCAAConfData.AVG_GSR_N_1998_SA = NCAACollegeData.Sum(item => item.GSR_N_1998_SA);
            NCAAConfData.AVG_GSR_N_1997_SA = NCAACollegeData.Sum(item => item.GSR_N_1997_SA);
            NCAAConfData.AVG_GSR_N_1996_SA = NCAACollegeData.Sum(item => item.GSR_N_1996_SA);
            NCAAConfData.AVG_GSR_N_1995_SA = NCAACollegeData.Sum(item => item.GSR_N_1995_SA);
            NCAAConfData.AVG_GSR_2011_SA = NCAACollegeData.Sum(item => item.GSR_2011_SA);
            NCAAConfData.AVG_GSR_2010_SA = NCAACollegeData.Sum(item => item.GSR_2010_SA);
            NCAAConfData.AVG_GSR_2009_SA = NCAACollegeData.Sum(item => item.GSR_2009_SA);
            NCAAConfData.AVG_GSR_2008_SA = NCAACollegeData.Sum(item => item.GSR_2008_SA);
            NCAAConfData.AVG_GSR_2007_SA = NCAACollegeData.Sum(item => item.GSR_2007_SA);
            NCAAConfData.AVG_GSR_2006_SA = NCAACollegeData.Sum(item => item.GSR_2006_SA);
            NCAAConfData.AVG_GSR_2005_SA = NCAACollegeData.Sum(item => item.GSR_2005_SA);
            NCAAConfData.AVG_GSR_2004_SA = NCAACollegeData.Sum(item => item.GSR_2004_SA);
            NCAAConfData.AVG_GSR_2003_SA = NCAACollegeData.Sum(item => item.GSR_2003_SA);
            NCAAConfData.AVG_GSR_2002_SA = NCAACollegeData.Sum(item => item.GSR_2002_SA);
            NCAAConfData.AVG_GSR_2001_SA = NCAACollegeData.Sum(item => item.GSR_2001_SA);
            NCAAConfData.AVG_GSR_2000_SA = NCAACollegeData.Sum(item => item.GSR_2000_SA);
            NCAAConfData.AVG_GSR_1999_SA = NCAACollegeData.Sum(item => item.GSR_1999_SA);
            NCAAConfData.AVG_GSR_1998_SA = NCAACollegeData.Sum(item => item.GSR_1998_SA);
            NCAAConfData.AVG_GSR_1997_SA = NCAACollegeData.Sum(item => item.GSR_1997_SA);
